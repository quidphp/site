...
abstract class Poll extends Core\RowAlias
{
	...
	public static $config = array(
		'cols'=>array(
			'json_fr'=>array('class'=>Core\Col\JsonArray::class,'exists'=>false),
			'json_en'=>array('class'=>Core\Col\JsonArray::class,'exists'=>false)),
		'@cms'=>array(
			'route'=>array(
	...
	public static function specificOperation(self $row):string 
	{
		...
		if($row->table()->hasPermission('specificOperation'))
		{
			...
			{
				$segment = array('table'=>$table,'order'=>'id','direction'=>'desc','filter'=>array('poll_id'=>$row));
