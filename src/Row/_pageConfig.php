...
{
	// config
	public static $configPageConfig = array(
		'route'=>array(
			'app'=>array(self::class,'dynamicRoute')),
		'cols'=>array(
			'route'=>array(
				'visible'=>array('role'=>array('>='=>70)),
				'required'=>true)),
		'routeKey'=>'app', // custom
		'@app'=>array(
			'route'=>array(
				0=>array(self::class,'dynamicRoute'))),
	);
