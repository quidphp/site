...
class Col extends Base\Test
{
	...
	public static function trigger(array $data):bool
	{
		...
		// googleMaps
		$localization = new Main\Localization(array('address'=>'ok','lat'=>2,'lng'=>1,'input'=>'whét asd','countryCode'=>'ca'));
		...
		// vimeo
		$vimeo = array('title'=>'James','html'=>'test','thumbnail_url'=>'http://image.com','provider_url'=>'https://vimeo.com','video_id'=>'132132','description'=>'bla','upload_date'=>'2018-07-25 23:30:36');
		...
		// core
		assert($tb->colAttr('myVideo') === array('class'=>Site\Col\Vimeo::class));
